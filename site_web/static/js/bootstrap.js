...
(function (global, factory) {
  ...
  class Dropdown extends BaseComponent {
    ...
    show() {
      ...
      if (this._inNavbar) {
        ...
        if (isDisplayStatic) {
          Manipulator.setDataAttribute(this._menu, 'popper', 'css');
        }
    ...
    _getPopperConfig() {
      ...
      }; // Disable Popper if we have a css display

      if (this._config.display === 'css') {
  ...
  const CLASS_NAME_STATIC = 'modal-css';
